...
public class TableTools {
    ...
    public static class TableKeyEventHandler implements EventHandler<KeyEvent> {
        ...
        KeyCodeCombination copyKeyCodeCompination = new KeyCodeCombination(KeyCode.C, KeyCombination.SHORTCUT_DOWN);
        KeyCodeCombination pasteKeyCodeCompination = new KeyCodeCombination(KeyCode.V, KeyCombination.SHORTCUT_DOWN);
        @Override
    ...
    public static void copySelectionToClipboard(TableView<?> table) {
        ...
        for (TablePosition position : positionList) {
            ...
            Object observableValue = table.getVisibleLeafColumn(col).getCellObservableValue( row);
